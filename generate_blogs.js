...
const projects = [
  { id: 'iot-conveyor', title: 'IoT-Based Smart Conveyor', desc: 'A dummy blog post discussing the development of the IoT-Based Smart Conveyor.' },
  { id: 'badhan', title: 'Badhan Web Automation', desc: 'A dummy blog post discussing the development of the Badhan Web Automation project.' },
  { id: 'iot-platform', title: 'IoT-Enabled Web Platform', desc: 'A dummy blog post discussing the development of the IoT-Enabled Web Platform.' },
  { id: 'bezierlab', title: 'BezierLab', desc: 'A dummy blog post discussing the development of the BezierLab application.' },
  { id: 'bnwp', title: 'BNWP WikiConnect Theme', desc: 'A dummy blog post discussing the development of the BNWP WikiConnect Theme.' },
  { id: 'querynest', title: 'QueryNest', desc: 'A dummy blog post discussing the development of QueryNest.' },
  { id: 'shoe-shiner', title: 'Shoe Shiner Pro', desc: 'A dummy blog post discussing the prototyping of Shoe Shiner Pro.' }
];

const template = (title, desc) => `<!DOCTYPE html>
<html lang="en">
<head>
  <!-- Google tag (gtag.js) -->
...
<body class="bg-white text-black min-h-screen flex flex-col selection:bg-black selection:text-white">
  ...
  <main class="flex-grow max-w-3xl mx-auto px-6 pt-32 pb-24 w-full">
    <article class="mb-16">
      ...
      <img src="https://placehold.co/800x400/f3f4f6/1f2937?text=${encodeURIComponent(title)}" alt="${title}" class="w-full h-auto object-cover mb-12 border border-black">
  ...
  <footer class="border-t border-black bg-gray-50 text-black mt-auto">
    <div class="max-w-6xl mx-auto px-6 py-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4 mb-10">
        ...
        <!-- 1. Official Email -->
        <a href="mailto:muqtadir@iat.buet.ac.bd"
          class="group flex items-center gap-3 py-1.5 transition-colors">
          <div class="w-8 h-8 rounded border border-black/25 bg-white flex items-center justify-center shrink-0 group-hover:border-black group-hover:bg-black group-hover:text-white transition-colors">
        ...
        <!-- 2. Personal Email -->
        <a href="mailto:mmfuad01@gmail.com"
          class="group flex items-center gap-3 py-1.5 transition-colors">
          <div class="w-8 h-8 rounded border border-black/25 bg-white flex items-center justify-center shrink-0 group-hover:border-black group-hover:bg-black group-hover:text-white transition-colors">
        ...
        <!-- 8. Curriculum Vitae -->
        <a href="https://drive.google.com/drive/folders/1JUhDSJzOHMZNoj8A99ni9DeYwGfImAQz?usp=sharing" target="_blank" rel="noopener noreferrer"
          class="group flex items-center gap-3 py-1.5 transition-colors">
          <div class="w-8 h-8 rounded border border-black/25 bg-white flex items-center justify-center shrink-0 group-hover:border-black group-hover:bg-black group-hover:text-white transition-colors">
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <!-- Bottom Line -->
      <div class="border-t border-black/20 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs font-mono text-gray-600">
...
projects.forEach(p => fs.writeFileSync(`blog-${p.id}.html`, template(p.title, p.desc)));
