...
async function main() {
  try {
    ...
    fs.writeFileSync('c:/Users/DELL/Desktop/venv-python/portfolio-ai/portfolio-static/md-muqtadir-fuad.github.io/scratch/ref_exact.png', Buffer.from(shot.data, 'base64'));
    console.log('Saved screenshot to scratch/ref_exact.png');
